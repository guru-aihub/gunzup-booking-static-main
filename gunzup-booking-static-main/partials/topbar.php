                ...
                <div class="dropdown topbar-item">
                    ...
                    >
                        ...
                        <div data-simplebar style="max-height: 280px">
                            <!-- Item -->
                            <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap" data-bs-toggle="modal" data-bs-target="#bookingModal">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="mb-0">
                                            <span class="fw-medium">Josephine Thompson </span>Booked {Package Name} for {Date} at {Time}</span>
                                        </p>
                                    </div>
                                </div>
                            </a>
                ...
                <div class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="profile.php">
                            <i
                                class="bx bx-user text-muted fs-18 align-middle me-1"
                            ></i
                            ><span class="align-middle">Profile</span>
                        </a>
                        <a class="dropdown-item" href="subscription.php">
                            <i
                                class="bx bx-credit-card text-muted fs-18 align-middle me-1"
                            ></i
                        ...
                        <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">
                            <i
                                class="bx bx-cog text-muted fs-18 align-middle me-1"
                            ></i
