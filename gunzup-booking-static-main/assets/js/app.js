...
class FormAdvanced {
    ...
    initFormChoices() {
        ...
        choicesExamples.forEach(function (item) {
            ...
            if (isChoicesVal["data-placeholder"]) {
                choiceData.placeholder = true;
                choiceData.placeholderValue = isChoicesVal["data-placeholder"].value;
            }
            ...
            if (isChoicesVal["data-choices-search-placeholder"]) {
                choiceData.searchPlaceholderValue = isChoicesVal["data-choices-search-placeholder"].value;
            }
...
class ThemeLayout {
     ...
     setSwitchFromConfig() {
          ...
          if (config) {
               ...
               var darkModeToggle = document.querySelector('#light-dark-mode iconify-icon');
               if (darkModeToggle) {
                    if (config.theme === 'dark') {
                         // Show sun icon when in dark mode (clicking will switch to light)
                         darkModeToggle.setAttribute('icon', 'iconamoon:mode-light-duotone');
                    } else {
                         // Show moon icon when in light mode (clicking will switch to dark)
                         darkModeToggle.setAttribute('icon', 'iconamoon:mode-dark-duotone');
                    }
               }
          }
     }
