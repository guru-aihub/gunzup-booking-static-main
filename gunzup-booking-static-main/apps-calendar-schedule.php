                                    ...
                                    <form class="needs-validation" name="event-form" id="forms-event" novalidate>
                                        ...
                                        <div class="modal-body px-3 pb-3 pt-0">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        <label class="control-label form-label">Package Name</label>
                                                        <input class="form-control" placeholder="Insert Package NameName" type="text" name="title" id="event-title" required />
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="row g-3">
                                                              <div class="col-md-5 offset-md-1">
                                                                <label for="booked-date" class="form-label">Booked Time</label>
                                                                <input class="form-control" id="choices-text-unique-values" data-choices data-choices-text-unique-true type="text" value="9:30" />
                                                              </div>
                                                              <div class="col-md-5">
                                                                <label for="booked-date" class="form-label">Available Times</label>
                                                                <input class="form-control" id="choices-text-disabled" data-choices data-choices-text-disabled-true type="text" value="10:00, 10:30, 11:00, 12:30, 1:00, 1:30" />
                                                              </div>
                                                            </div>
