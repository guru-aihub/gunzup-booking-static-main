                        ...
                        <div class="card-body px-3 py-5">
                            ...
                            <div class="px-4">
                                <form action="index.php" class="authentication-form">
                                    ...
                                    <div class="mb-3">
                                        <a href="resetpassword.php" class="float-end text-muted text-unline-dashed ms-1">Reset password</a>
                                ...
                                <p class="text-muted mb-0 text-center mt-3">
                                    New here?
                                    <a href="signup.php" class="text-decoration-none fw-bold ms-1">Sign Up</a>
                                </p>
                            </div>
                            <!-- end col -->
                        </div>
